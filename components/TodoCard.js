            ...
            <div className="card-body p-3">
                <div className="d-flex align-items-center">
                    ...
                    <div className="d-flex align-items-center gap-1">
                        <button 
                            onClick={() => setIsEditing(true)}
                            className="btn btn-sm btn-icon-edit-custom d-flex align-items-center justify-content-center"
                        ...
                        <button 
                            ...
                            className="btn btn-sm btn-icon-delete-custom d-flex align-items-center justify-content-center"
